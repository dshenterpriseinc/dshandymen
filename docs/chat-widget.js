...
'    overflow:hidden;box-shadow:0 12px 40px rgba(10, 23, 26, .35);z-index:9001;',
...
'  .bot{align-self:flex-start;background:' + p.bubbleBot + ';color:#0A171A;border-bottom-left-radius:4px;',
'    box-shadow:0 1px 3px rgba(10, 23, 26, .10)}',
...
'  .sys{align-self:center;font-size:13px;color:#44565A;font-style:italic;padding:2px 0}',
...
'  input{flex:1;min-height:44px;border:1.5px solid rgba(10, 23, 26, .30);border-radius:8px;padding:9px 12px;',
'    font-size:16px;background:#fff;color:#0A171A}',
...
'  .pmic{min-width:44px;min-height:44px;border-radius:8px;border:1.5px solid rgba(10, 23, 26, .30);',
'    background:#fff;cursor:pointer;font-size:17px;display:grid;place-items:center;color:#0A171A}',
'  .pmic[aria-pressed="true"]{background:var(--usr-bg,' + p.bubbleUser + ');color:#fff}',
'  .send:focus-visible,.pmic:focus-visible{outline:2px solid #0A171A;outline-offset:2px}',
...
'  .typing i{width:6px;height:6px;border-radius:50%;background:#75898E;display:inline-block;',
