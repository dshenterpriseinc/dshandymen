...
(function () {
  ...
  var SEASONS = {
    'deep-winter': {
      label: 'Deep Winter', slug: 'winter', bg: '#0A171A', pos: 'center 46%',
    ...
    'thaw': {
      label: 'Thaw', slug: 'thaw', bg: '#132E35', pos: 'center 32%',
    ...
    'green': {
      label: 'Green', slug: 'green', bg: '#132E35', pos: 'center 38%',
    ...
    'leaf-fall': {
      label: 'Leaf-Fall', slug: 'leaffall', bg: '#262E30', pos: 'center 28%',
